...
export default function About() {
  return (
    ...
    <div className="about-text d-flex flex-column gap-4 align-items-center justify-content-center">
      <div className='d-flex justify-content-center align-items-center'>
        <div className="heading-img">
        <img src={gif} alt="" width="100%" className='gif-image'/>
        </div>
      <h1>About Us</h1>
      </div>
      ...
      <div className='about-gif'>
        <img src={gif} alt="Developer Coding" width={"100%"}/>
      </div>
